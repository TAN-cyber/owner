...
const TRANSLATIONS: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    setupComplete: 'Owner setup complete!',
    installed: 'Installed:',
    ...
    getStartedTweak: '/owner-tweak        — Small change (skip brainstorming and plan)',
    ...
    noInstallsFound: 'No platforms with owner skills installed. Run `owner init` first.',
    updatingSkillsOnTargets: 'Updating owner skills on',
    ...
    uninstallTitle: 'Owner Uninstall',
    ...
    workingDirectoriesPreservedReason:
      'Reason: Owner does not manage the listed content, so it was left unchanged.',
    workingDirectoriesPreservedImpact:
      'Impact: Owner was uninstalled successfully; the preserved content remains unchanged.',
    ...
    noOwnerInstallationsFound: 'No Owner installations found. Nothing to uninstall.',
  ...
  zh: {
    settingUp: '正在设置 Owner：',
    installScope: '安装范围：',
    scopeProject: '项目（当前目录）',
    scopeGlobal: '全局（主目录）',
    languagePrompt: 'Owner 技能语言：',
    ...
    getStartedTweak: '/owner-tweak        — 小改动（跳过 brainstorming 和完整 plan）',
    ...
    noInstallsFound: '未检测到已安装 owner skills 的平台。请先运行 `owner init`。',
    updatingSkillsOnTargets: '正在更新 owner skills，覆盖',
    ...
    workingDirectoriesPreservedReason: '原因：这些内容不由 Owner 管理，因此未删除。',
    workingDirectoriesPreservedImpact: '影响：不影响 Owner 卸载完成，保留内容未被修改。',
    ...
    noOwnerInstallationsFound: '未找到 Owner 安装项，无需卸载。',
    summaryTargets: '目标：',
