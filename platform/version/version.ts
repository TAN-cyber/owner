...
/**
 * Get the current installed Owner version from package.json.
 */
 ...
 * Used by `owner init` and `owner update` at the start of command output.
 */
export async function printVersionInfo(
  ...
  log(`  Owner v${result.currentVersion}`);
