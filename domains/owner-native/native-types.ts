...
export const NATIVE_CHANGE_SCHEMA = 'owner.native.v3' as const;
export const NATIVE_V2_CHANGE_SCHEMA = 'owner.native.v2' as const;
export const NATIVE_LEGACY_CHANGE_SCHEMA = 'owner.native.v1' as const;
export const NATIVE_TRANSITION_SCHEMA = 'owner.native.transition.v3' as const;
export const NATIVE_V2_TRANSITION_SCHEMA = 'owner.native.transition.v2' as const;
export const NATIVE_LEGACY_TRANSITION_SCHEMA = 'owner.native.transition.v1' as const;
...
export type OwnerProjectConfig = WorkflowNativeEnabledProjectConfig;
...
export interface NativeContinuation {
  schema: 'owner.native.continuation.v1';
  skill: 'owner-native';
  change: string;
  phase: NativePhase;
  revision: number;
...
export interface NativeCheckpointManifest {
  schema: 'owner.native.checkpoint-manifest.v1';
  change: string;
...
export interface NativeProgressCheckpoint {
  schema: 'owner.native.progress-checkpoint.v1';
  id: string;
  change: string;
  phase: NativePhase;
...
export interface NativeCheckpointJournal {
  schema: 'owner.native.checkpoint-journal.v1';
  id: string;
  change: string;
  inputHash: string;
  createdAt: string;
...
export interface NativeAcceptancePageProjection {
  schema: 'owner.native.acceptance-page.v1';
...
export interface NativeSchemaMigrationJournal {
  schema: 'owner.native.schema-migration.v1';
  id: string;
  change: string;
...
export interface NativeTransactionJournal {
  schema: 'owner.native.transaction.v1';
  id: string;
