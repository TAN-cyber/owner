...
export const NATIVE_CHECK_RECEIPT_SCHEMA = 'owner.native.check-receipt.v1' as const;
export const NATIVE_CHECK_RECEIPT_HASH_TAG = 'owner.native.check-receipt.v1';
...
const CHECKER_HASH_TAG = 'owner.native.checker-policy.v1';
const CHECK_INPUT_HASH_TAG = 'owner.native.check-input.v1';
