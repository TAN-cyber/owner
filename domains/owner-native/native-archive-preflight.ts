...
export const NATIVE_ARCHIVE_PREFLIGHT_SCHEMA = 'owner.native.archive-preflight.v1' as const;

const PREFLIGHT_HASH_TAG = 'owner.native.archive-preflight.v1';
const OPERATION_HASH_TAG = 'owner.native.archive-operation.v1';
...
function normalizeWorkspace(
  ...
  if (value.schema !== 'owner.native.workspace.v3') {
