...
const ACCEPTANCE_TRACE_HASH_TAG = 'owner.native.acceptance-trace.v2';
const PARTIAL_ALLOWANCE_HASH_TAG = 'owner.native.partial-allowance.v1';
const VERIFICATION_ENVELOPE_HASH_TAG = 'owner.native.verification-evidence.v2';
...
export interface NativeAcceptanceEvidenceTrace {
  schema: 'owner.native.acceptance-trace.v2';
...
export interface NativePartialAllowance {
  schema: 'owner.native.partial-allowance.v1';
  change: string;
  scopeHash: string;
  scopeIds: string[];
  reason: string;
...
export interface NativeVerificationEvidenceEnvelope {
  schema: 'owner.native.verification-evidence.v2';
  change: string;
  sourceRevision: number;
  result: 'pass' | 'fail';
...
function acceptanceCriteriaHash(criteria: readonly NativeAcceptanceCriterion[]): string {
  return canonicalHash(
    'owner.native.acceptance-set.v1',
...
export function buildNativeAcceptanceEvidenceTrace(
  ...
  const content = {
    schema: 'owner.native.acceptance-trace.v2' as const,
    nativeRootRef,
    criteriaHash,
...
export function buildNativePartialAllowance(input: {
  ...
  const content = {
    schema: 'owner.native.partial-allowance.v1' as const,
...
export function buildNativeVerificationEvidenceEnvelope(input: {
  ...
  const content = {
    schema: 'owner.native.verification-evidence.v2' as const,
    change: changeName(input.change),
    sourceRevision: positiveRevision(input.sourceRevision),
    result: input.result,
...
export function parseNativeAcceptanceEvidenceTrace(value: unknown): NativeAcceptanceEvidenceTrace {
  ...
  if (
    root.schema !== 'owner.native.acceptance-trace.v2' ||
...
export function parseNativePartialAllowance(value: unknown): NativePartialAllowance {
  ...
  if (
    root.schema !== 'owner.native.partial-allowance.v1' ||
...
export function parseNativeVerificationEvidenceEnvelope(
  ...
  if (
    root.schema !== 'owner.native.verification-evidence.v2' ||
    typeof root.change !== 'string' ||
