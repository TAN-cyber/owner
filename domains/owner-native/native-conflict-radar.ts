...
export const NATIVE_CONFLICT_RADAR_SCHEMA = 'owner.native.conflict-radar.v1' as const;
...
const RADAR_HASH_TAG = 'owner.native.conflict-radar.v1';
const SIGNAL_SET_HASH_TAG = 'owner.native.conflict-radar-signals.v1';
