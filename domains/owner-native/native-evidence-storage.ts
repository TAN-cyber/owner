...
export async function writeNativeVerificationReportSnapshot(options: {
  ...
  return writeEvidenceDocument({
    ...
    hash: options.hash,
    value: {
      schema: 'owner.native.verification-report.v1',
...
export async function readNativeVerificationReportSnapshot(
  ...
  if (
    ...
    report.schema !== 'owner.native.verification-report.v1' ||
...
function parseLegacyArchivedAcceptanceCounts(
  ...
  if (envelope.schema !== 'owner.native.verification-evidence.v1') return null;
  ...
  if (
    counts.schema !== 'owner.native.acceptance-trace.v1' ||
...
export async function writeNativeVerificationEvidence(options: {
  ...
  if (evidence.schema !== 'owner.native.verification-evidence.v2') {
