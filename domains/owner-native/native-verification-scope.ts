...
export const NATIVE_IMPLEMENTATION_SCOPE_SCHEMA = 'owner.native.implementation-scope.v2' as const;
export const NATIVE_SNAPSHOT_PROJECTION_SCHEMA =
  'owner.native.content-snapshot-projection.v1' as const;

const SNAPSHOT_PROJECTION_HASH_TAG = 'owner.native.content-snapshot-projection.v1';
const IMPLEMENTATION_SCOPE_HASH_TAG = 'owner.native.implementation-scope.v2';
const UNRESOLVED_SCOPE_ID_TAG = 'owner.native.unresolved-scope-id.v1';
const SCOPE_DETAIL_OVERFLOW_HASH_TAG = 'owner.native.scope-detail-overflow.v1';
const SNAPSHOT_PROJECTION_OVERFLOW_HASH_TAG = 'owner.native.snapshot-projection-overflow.v2';
