        ...
        return success(
          'archive --dry-run',
          {
            ...
            continuation: {
              ...
              commandArgs: ['owner', 'native', 'archive', name, '--confirmed'],
              inputOptions: [],
              runnerAction: null,
            },
          },
    ...
    try {
      ...
      const commandArgs =
        error.peers.length > 0
          ? ['owner', 'native', 'archive', name, '--confirmed', '--serial-first', name]
          : ['owner', 'native', 'archive', name, '--confirmed'];
      return {
        command: 'archive',
        exitCode: 73,
        data: {
  ...
  if (dryRun) {
    return {
      ...
      data: {
        ...
        repairCommand: `owner native doctor ${name} --repair`,
      },
      error: {
        code: 'invalid-data',
