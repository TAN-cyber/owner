...
export function parseNativeCheckpointManifestValue(
  ...
  if (manifest.schema !== 'owner.native.checkpoint-manifest.v1') {
...
export function parseNativeProgressCheckpointValue(
  ...
  if (checkpoint.schema !== 'owner.native.progress-checkpoint.v1') {
...
export function parseNativeCheckpointJournalValue(
  ...
  if (journal.schema !== 'owner.native.checkpoint-journal.v1') {
