...
export const NATIVE_RUNTIME_PACKAGE: SkillPackage = {
  ...
  definition: {
    ...
    metadata: {
      ...
      version: '3',
      description: 'Owner-owned state runtime for the Native workflow.',
    },
    goal: {
...
export const NATIVE_RUNTIME_HASH = sha256Text('owner-native-runtime:v3:scope-reopen');
export const NATIVE_LEGACY_RUNTIME_IDENTITIES = [
  {
    skillVersion: '3',
    skillHash: sha256Text('owner-native-runtime:v3:semantic-repair-budget'),
  },
  {
    skillVersion: '2',
    skillHash: sha256Text('owner-native-runtime:v2:max-iterations-32'),
  },
  {
    skillVersion: '1',
    skillHash: sha256Text('owner-native-runtime:v1'),
  },
] as const;
