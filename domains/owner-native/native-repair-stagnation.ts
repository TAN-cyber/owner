...
export const NATIVE_REPAIR_SIGNATURE_SCHEMA = 'owner.native.repair-signature.v1' as const;
...
const SIGNATURE_HASH_TAG = 'owner.native.repair-signature.v1';
const OVERRIDE_SUMMARY_HASH_TAG = 'owner.native.repair-override-summary.v1';
