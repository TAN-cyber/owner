...
describe('Loop verification receipt v3', () => {
  it.each([
    [
      'automated-check',
      {
    ...
    [
      'static-inspection',
      {
        subjects: ['domains/owner-loop/loop-verification-runtime.ts'],
    ...
    expect(parseLoopVerificationReceipt(receipt)).toEqual(receipt);
