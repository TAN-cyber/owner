...
vi.mock('../../../domains/owner-native/native-workspace.js', () => workspace);
...
} from '../../../domains/owner-native/native-workspace-finish.js';
import type { NativePortableState } from '../../../domains/owner-native/native-portable-types.js';
import type {
  NativeProjectPaths,
  NativeChangeState,
} from '../../../domains/owner-native/native-types.js';
import type { NativeWorkspaceIdentityV3 } from '../../../domains/owner-native/native-workspace.js';
...
const paths: NativeProjectPaths = {
  ...
  artifactRootRef: '.',
  nativeRoot: path.join(projectRoot, 'owner'),
  ...
  runtimeDir: path.join(projectRoot, '.owner', 'runtime', 'native'),
  changesRuntimeDir: path.join(projectRoot, '.owner', 'runtime', 'native', 'changes'),
  locksDir: path.join(projectRoot, '.owner', 'runtime', 'native', 'locks'),
  transactionsDir: path.join(projectRoot, '.owner', 'runtime', 'native', 'transactions'),
};

const identity = (): NativeWorkspaceIdentityV3 => ({
  schema: 'owner.native.workspace.v3',
