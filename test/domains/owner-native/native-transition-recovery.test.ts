...
import { archiveNativeChange } from '../../../domains/owner-native/native-archive.js';
import { inspectNativeArchivePreflight } from '../../../domains/owner-native/native-archive-inspection.js';
import {
  createNativeChange,
  nativeChangeDir,
  readNativeChange,
} from '../../../domains/owner-native/native-change.js';
import { inspectNativeStatus } from '../../../domains/owner-native/native-diagnostics.js';
import { doctorNativeProject } from '../../../domains/owner-native/native-doctor.js';
import { sha256Text } from '../../../domains/owner-native/native-hash.js';
import {
...
} from '../../../domains/owner-native/native-run-store.js';
import {
  inspectPendingNativeSchemaMigration,
  migrateNativeChange,
  nativeSchemaMigrationJournalFile,
} from '../../../domains/owner-native/native-schema-migration.js';
import {
  nativeBaselineManifestFile,
  readNativeBaselineManifest,
} from '../../../domains/owner-native/native-snapshot.js';
import {
...
} from '../../../domains/owner-native/native-transition-journal.js';
import { appendNativeTrajectoryEvent } from '../../../domains/owner-native/native-trajectory.js';
import { repairNativeTrajectoryTail } from '../../../domains/owner-native/native-trajectory-recovery.js';
import type {
  NativeChangeState,
  NativeProjectPaths,
...
describe('Native transition recovery', () => {
  ...
  beforeEach(async () => {
    projectRoot = await fs.mkdtemp(path.join(os.tmpdir(), 'owner-native-transition-recovery-'));
  ...
  it.each<{
    ...
    async ({ hooks, prewriteEvents }) => {
      ...
      legacyNextRun.skillHash = sha256Text('owner-native-runtime:v1');
      await fs.writeFile(changeFile, stringify(legacyState(stateAtCrash)));
      ...
      ).rejects.toThrow('run owner native doctor recover-transition --repair before mutating it');
