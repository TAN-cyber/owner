...
import {
  ...
  takeMany,
  takeOption,
} from '../../../domains/owner-native/native-cli-shared.js';
import {
...
import { NativeVerificationReceiptBindingError } from '../../../domains/owner-native/native-verification-runtime.js';
...
describe('Native CLI shared helpers', () => {
  ...
  it('reads bounded evidence files and reports non-regular and oversized inputs', async () => {
    const root = await fs.mkdtemp(path.join(os.tmpdir(), 'owner-native-cli-shared-'));
