...
import { nativeCheckpointJournalFile } from '../../../domains/owner-native/native-checkpoint-storage.js';
...
describe('Native resume status view', () => {
  ...
  beforeEach(async () => {
    projectRoot = await fs.mkdtemp(path.join(os.tmpdir(), 'owner-native-resume-view-'));
  ...
  it('keeps default status compact and exposes bounded details on demand', async () => {
    ...
    expect(compact).toMatchObject({
      ...
      detailsCommand: 'owner native status compact-resume --details',
