...
} from '../../../domains/owner-native/native-portable-archive.js';
import {
...
import { writeNativePortableState } from '../../../domains/owner-native/native-portable-state.js';
...
describe('Native portable Archive', () => {
  ...
  beforeEach(async () => {
    root = await fs.mkdtemp(path.join(os.tmpdir(), 'owner-native-archive-v4-'));
