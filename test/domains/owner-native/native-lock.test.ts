...
} from '../../../domains/owner-native/native-lock.js';
...
import { withNativeTransitionLock } from '../../../domains/owner-native/native-transition-journal.js';
...
describe('Native operation locks', () => {
  ...
  beforeEach(async () => {
    projectRoot = await fs.mkdtemp(path.join(os.tmpdir(), 'owner-native-lock-'));
