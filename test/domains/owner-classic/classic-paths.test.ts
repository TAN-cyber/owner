...
import * as classicPaths from '../../../domains/owner-classic/classic-paths.js';
...
describe('Classic change paths', () => {
  ...
  beforeEach(async () => {
    projectRoot = await fs.mkdtemp(path.join(os.tmpdir(), 'owner-classic-paths-'));
    outsideRoot = await fs.mkdtemp(path.join(os.tmpdir(), 'owner-classic-paths-outside-'));
