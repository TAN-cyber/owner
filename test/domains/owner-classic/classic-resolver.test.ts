...
} from '../../../domains/owner-classic/classic-resolver.js';
import type { ClassicEvidence } from '../../../domains/owner-classic/classic-evidence.js';
...
const cases: ResolverCase[] = [
  ...
  },
  {
    ...
    classic: state({ phase: 'design', handoffContext: '.owner/context.json' }),
